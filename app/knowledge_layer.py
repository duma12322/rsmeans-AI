...
DIVISION_KNOWLEDGE = {
    "1": {
        ...
        "keywords": ["permit", "fee", "insurance", "bond", "contingency", "mobilization", "temporary", "scaffolding rental", "project management", "architect fee", "engineering fee", "superintendent", "overhead", "general conditions", "concrete", "diesel", "air", "cfm", "electric", "plank", "scaffolding", "aluminum", "portable", "pump", "safety", "self-propelled", "crane", "trailer"],
    ...
    "2": {
        ...
        "keywords": ["demolish", "tear down", "remove existing", "demo", "asbestos", "lead paint", "mold remediation", "abatement", "deconstruct", "strip out", "gut", "clearance", "existing wall removal", "concrete breaking", "removal", "diameter pipe", "excludes excavation", "plastic", "deconstruction", "reinforcing", "brick", "masonry", "interior", "natural gas", "water", "demolition", "bituminous"],
    ...
    "4": {
        ...
        "keywords": ["brick", "block", "CMU", "masonry", "mortar", "stone wall", "glass block", "laying brick", "block wall", "retaining wall masonry", "tuckpointing", "grout masonry", "hard mortar", "old mortar", "concrete block", "bars", "diameter", "soil biological", "galvanized", "running bond"],
    ...
    "5": {
        ...
        "keywords": ["steel", "structural steel", "metal stud", "steel beam", "steel column", "joist", "metal deck", "railing", "stair steel", "ladder", "grating", "metal framing", "erection", "bolt", "weld", "angle iron", "recycled materials", "tons", "studs", "stainless steel", "framing", "shop fabricated", "bar", "channel", "concrete", "field fabricated", "joist stud", "anchors"],
    ...
    "7": {
        ...
        "keywords": ["roof", "roofing", "waterproof", "insulation", "vapor barrier", "air barrier", "caulk", "sealant", "flashing", "membrane", "TPO", "EPDM", "shingles", "dampproof", "fireproof", "spray foam", "batt insulation", "rigid insulation", "gutters", "pneumatic nailed", "fiberglass", "glass fiber", "galvanized steel", "accessories", "mill finish", "stainless steel", "base sheet", "concrete", "neoprene", "fully adhered"],
    ...
    "9": {
        ...
        "keywords": ["drywall", "gypsum board", "sheetrock", "tile", "floor tile", "wall tile", "carpet", "vinyl flooring", "LVT", "paint", "painting", "acoustic ceiling", "suspended ceiling", "ceiling tile", "plaster", "terrazzo", "epoxy floor", "wall covering", "texture", "exterior latex", "metal studs"],
    ...
    "12": {
        ...
        "keywords": ["furniture", "desk", "chair", "blind", "shade", "curtain", "rug", "artwork", "seating", "bench", "table", "shelving furniture", "diameter", "stainless steel", "base cabinets", "built-in", "cabinet", "laminated plastic", "powder coat", "vinyl"],
    ...
    "13": {
        ...
        "keywords": ["pre-engineered building", "metal building", "clean room", "swimming pool", "pool", "vault", "radiation shielding", "pre-engineered", "modular building", "gunite pool", "diameter", "eave height", "door", "roof", "clear span", "stainless steel", "air", "wood", "bottom", "concrete", "copper", "plastic", "x-ray", "controls"],
    ...
    "14": {
        ...
        "keywords": ["elevator", "escalator", "lift", "moving walk", "dumbwaiter", "platform lift", "wheelchair lift", "material lift", "floor height", "stainless steel", "automatic controls", "flooring", "hydraulic", "increased speed", "number stops", "opening speed", "speed doors", "stations", "travel"],
    ...
    "21": {
        ...
        "keywords": ["sprinkler", "fire suppression", "fire pump", "standpipe", "deluge", "dry pipe", "wet pipe", "halon", "clean agent", "FM-200", "fire protection piping", "hose", "polished brass", "polished chrome", "diameter", "valve", "container", "control", "sprinkler components", "valves", "fittings", "length", "pendent", "trim", "booster line", "dispersion nozzle"],
    ...
    "23": {
        ...
        "keywords": ["HVAC", "heating", "cooling", "air conditioning", "duct", "ductwork", "furnace", "boiler", "chiller", "cooling tower", "VAV", "fan coil", "rooftop unit", "RTU", "air handler", "AHU", "ventilation", "exhaust fan", "diffuser", "thermostat", "heat pump", "mini split", "split system", "mechanical", "ton cooling", "gpm", "hot water", "flanged", "motor", "exhaust", "insulation", "panel", "pneumatic thermostat", "roof", "water cooled", "watt", "wireless pneumatic", "air cooled", "ceiling", "centrifugal"],
    ...
    "27": {
        ...
        "keywords": ["data", "cable", "network", "ethernet", "Cat6", "fiber", "telecom", "telephone", "PA system", "audio visual", "AV", "speaker", "distributed antenna", "DAS", "low voltage data", "call station", "conduits", "multi mode", "panel", "rack", "single mode", "splice", "wires", "amplifier", "antenna", "bedside", "bell", "burial", "button", "cables"],
    ...
    "31": {
        ...
        "keywords": ["excavation", "grading", "earthwork", "cut", "fill", "backfill", "compaction", "trenching", "clearing", "grubbing", "dewatering", "soil", "earth", "grade", "erosion control", "silt fence", "topsoil", "embankment", "soil nailing"],
    ...
    "33": {
        ...
        "keywords": ["water main", "sewer main", "storm sewer", "utility", "underground pipe", "ductbank", "manhole", "catch basin", "fire hydrant", "gas main", "force main", "site utility", "diameter sdr", "diameter pipe", "gallons", "excavation backfill", "diameter band", "fittings", "pipe freezing", "equivalent", "freezing side", "inlet", "kcmil", "basic wind", "service", "wind speed", "box", "ips diameter", "wall thickness", "butt fusion", "diameters"],
    ...
    "34": {
        ...
        "keywords": ["roadway", "bridge", "tunnel", "railroad", "rail", "transit", "highway", "pavement structure", "guardrail", "steel", "new rail", "ties", "coat", "epoxy", "security barrier", "threshold", "crash barrier", "maintenance grading", "switch", "assembly"],
    ...
    "35": {
        ...
        "keywords": ["dock", "pier", "bulkhead", "dredge", "marine", "waterfront", "seawall", "boat ramp", "diameter", "boat", "aluminum", "docks", "protective material", "wrap protective", "deck", "gates", "octagon", "open area", "pile", "shore", "steel", "treated wood", "concrete piles", "floating", "levee"],
    ...
    "41": {
        ...
        "keywords": ["conveyor", "crane", "hoist", "material handling", "storage rack", "industrial equipment", "bulk material", "belt", "cranes", "length", "lifts", "trolley", "bridge", "electric", "girder", "hoists", "horizontal", "jib", "overhead", "piece", "portable", "running", "yard", "air", "assembly"],
    ...
    "44": {
        ...
        "keywords": ["pollution control", "air scrubber", "waste treatment", "environmental equipment", "filtration", "elbow", "vacuum", "central", "collection", "commercial", "dust", "filters", "flexible", "galvanized", "hose", "industrial", "motorized", "reinforced", "rubber", "shaker", "stand", "tubing", "wire"],
    ...
    "46": {
        ...
        "keywords": ["water treatment", "wastewater", "pump station", "filtration plant", "clarifier", "municipal water", "diameter", "connection", "gpd", "aeration", "blower", "second", "mgd", "air diffuser", "phase", "anchoring", "check", "excluding", "filter", "freeboard", "piping", "pressure relief", "relief valves", "silencer"],
    ...
    "48": {
        ...
        "keywords": ["generator", "solar", "photovoltaic", "PV", "wind turbine", "fuel cell", "cogeneration", "backup power", "standby generator", "renewable energy", "battery", "charging", "mount", "anode", "attic", "cells", "component", "components", "connected", "demonstration", "earth", "fuel", "galvanized", "grid", "guyed", "hardware", "helical"],
